...
import { READINGS, CATEGORY_COLORS, getSlug } from "../constants";
...
const PreviewContent = () => {
  ...
  // Use actual readings from constants
  const todayReading = READINGS[29]; // First reading as today's
  const vaultReadings = READINGS; // Next 6 for vault
  const previousReadings = READINGS.slice(7, 10); // Next 3 for previous
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <Header />
      <main className="max-w-6xl mx-auto px-6 pt-36 md:pt-48 pb-16">
        {/* Hero Section */}
        <div
        ...
        >
          ...
          <div className="inline-block bg-[#2A2A2A] px-6 py-2 rounded-lg">
        ...
        >
          ...
          <div className="lg:col-span-6">
            ...
            <div
              className="bg-[#1A1A1A] rounded-[24px] p-6 md:p-10 max-w-[280px] md:max-w-none mx-auto flex flex-col md:flex-row gap-6 md:gap-10 cursor-pointer hover:bg-[#222] transition-colors justify-center items-center"
            ...
            <div className="flex flex-col gap-2">
              {previousReadings.map((reading, index) => (
                <div
                  ...
                  className="p-4 py-3 flex items-center justify-between cursor-pointer hover:bg-[#222] transition-colors rounded-[12px]"
